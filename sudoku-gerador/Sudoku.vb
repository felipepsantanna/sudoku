...
#End Region
    ...
    Private Sub SudokuForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Next i
    End Sub
    Private Async Sub btnNewGame_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNewGame.Click
        ...
        For s = 201 To 300
            Dim classeSudoku As New SudokuClass
            classeSudoku.ID = s
            classeSudoku.Dificuldade = difficulty
            spnDifficulty.Value = difficulty
            While Not CreateSudokuGrid()
            End While


            For i = 1 To 81
                Dim nomeBloco As String = String.Concat("bloco", i.ToString())
                Dim personType As Type = GetType(SudokuClass)

                Dim _temp As String = "0"
                If CurButtons(i).Text <> "" Then
                    _temp = CurButtons(i).Text
                End If

                Dim propInfo As PropertyInfo = personType.GetProperty(nomeBloco)
                Dim b As New Bloco
                b.Gabarito = Convert.ToInt32(SudokuSolution(i))
                b.Initial = Convert.ToInt32(_temp)
                b.Valor = b.Initial

                If propInfo IsNot Nothing Then
                    propInfo.SetValue(classeSudoku, b)
                End If
            ...
            Using cliente As New HttpClient
                ...
                Dim res = Await cliente.PostAsync("https://api.rocktools.com.br/sudoku", New StringContent(JsonConvert.SerializeObject(classeSudoku), Encoding.UTF8, "application/json"))
